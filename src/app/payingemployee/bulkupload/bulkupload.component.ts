...
export class BulkuploadComponent implements OnInit {
  ...
  @ViewChild('fns') matFHAutocompletes: MatAutocomplete | any;
  @ViewChild('fnd') matFHAutocomplet: MatAutocomplete | any;
  @ViewChild('fnInputs') fnInputs: any;
  @ViewChild('fnds') matFHAutocomplets: MatAutocomplete | any;
  @ViewChild('fnsD') matFHAutocompleteD: MatAutocomplete | any;
  ...
  @ViewChild(MatAutocompleteTrigger) autocompleteTrig: MatAutocompleteTrigger | any;
  ...
  isLoading = false;
  selectedOption: any;
  emp_paysrtuctureform:any = FormGroup;
  deductsrtuctureform:any = FormGroup;
  paycomponent_array: any;
  paycomponentEarnings : any;
  
  functionalHeadList: any;
  editForm : any =FormGroup;
  editForms : any =FormGroup;
  editFormD : any =FormGroup;
  currentDate = new Date();
  fromDateControl = new FormControl();

  paystatusform!: FormGroup | any;
  isShowAddPage: boolean = false;
  empSearchForm!: FormGroup | any;
  empSearchForms!: FormGroup | any;
  empDSearchForms!: FormGroup | any;
  ...
  @ViewChild('labelImportDeduction')
  labelImportDeduction!: ElementRef;
  droplist :any= [];
  statusList = [
  ...
  ngOnInit(): void {
    ...
    this.emp_paysrtuctureform.get('employeepay_detail')?.valueChanges.subscribe((value_arrya:any) => {
    ...
    this.deductsrtuctureform.get('employeepay_detail')?.valueChanges.subscribe((value_arrya: any) => {
    ...
    this.paystatusform.get('paydetail')?.valueChanges.subscribe((value_arrya : any) => {
...
this.SpinnerService.hide();
  ...
  getSections(forms: { controls: { employeepay_detail:any }; }) {
  ...
  type_info(type_info: any, index: any) {
  ...
  type_infoded(type_info: any, index: any) {
  ...
  getSectionsded(forms: { controls: { employeepay_detail: { controls: any; }; }; }) {
    return forms.controls.employeepay_detail.controls;
  }

  deletepayded(i: number) {
  ...
  paycomponent_search(value: any) {
    this.uploadservice.getpaycomponents( value, 1).subscribe(data => {
      this.paycomponent_array = data['data'];
    });
  }
  paycomponent_searches(value: any) {
    let values = value.target.value;
    this.uploadservice.getpaycomponentEarning(values, 1).subscribe(data => {
      this.paycomponent_earn = data['data'];
    });
  }
  paycomponent_searchD(value: any) {
    let values = value.target.value;
    this.uploadservice.getpaycomponentDeduct(values, 1).subscribe(data => {
      this.paycomponent_deduct = data['data'];
    });
  }
  ...
  getSectionss(forms: { controls: { paydetail: { controls: any; }; }; }) {
  ...
  public displayFnFunHeads(fns?: FunctionHead): string | any {
  ...
  public displayFnFunHeadss(fn?: FunctionHead): string | any {
    return fn ? fn.full_name : undefined;
  }
  ...
  employeecomponent_search(value: any) {
    let values = value.target.value;
    this.uploadservice.getFunctionalHead(values, 1).subscribe(data => {
      this.functionalHeadList = data['data'];
    });
  }
  public displayFnFunHea(fnd?: FunctionHead): string | any {
  ...
  deleteAllowance(data: { id: undefined; }) {
...
*/
  ...
  public displayFnFunHeas(fnds?: FunctionHead): string | any {
...
this.SpinnerService.hide();
  ...
  deleteDeductions(data: { id: undefined; }) {
    if (data.id == undefined) {
      this.notification.showSuccess("Empty Row Deleted Successfully")
  ...
  public displayFnFunHeadD(fn?: FunctionHead): string | any {
    return fn ? fn.full_name : undefined;
  }
  ...
  paycomponent_searchs(value: string) {
    let page = 1;
