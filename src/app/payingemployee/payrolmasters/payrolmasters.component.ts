...
export class PayrolmastersComponent implements OnInit {
  ...
  constructor(private shareService: SharedService,
    ...
    ispaycategory: boolean = false;
    iscompcontrib: boolean = false;
    ispaycompo: boolean = false;
    ispaycompotype: boolean = false;
    istemplatesmaster: boolean = false;
    isSegmentMaster: boolean = false;
    isTemplateMapping: boolean = false;
    isPayrollMapping: boolean = false;
    isGradeMasters: boolean = false;
    isReportColumns: boolean = false;
