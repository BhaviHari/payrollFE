...
export class EmppayrollthbComponent implements OnInit, OnChanges {
  ...
  segmentdata() {
    ...
    this.finaldata.segment_details.forEach((data: any) => {
      ...
      if(data.paycomponent_data)
      {
      data.paycomponent_data.forEach((item: any) => {
    ...
    this.finaldata.company_contribution.forEach((ccdata: any) => {
    ...
    this.finaldata.employee_contribution.forEach((ecdata: any) => {
...
if (this.payrollgenform.get('deductions') !== null) {
  ...
  if (newDeduction !== null && newDeduction !== undefined) {  
    ...
    const existingIndex = employeecontribution.findIndex(
      (item: any) => item && item?.paycomponent_name === newDeduction?.paycomponent_name
    );
  ...
  getgradebasedemployeeinfo(grade_id: any) {
  ...
  _letcalculate(gross_pay_monthly: any) {
  ...
  onBonusTypeChange(data: any, index: any)
  {
  ...
  onBonusTypeChanges(data: any, index: any)
  {
  ...
  onBonusTypeChangeD(event: any, data: any)
  {
