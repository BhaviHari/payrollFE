...
export class PayrollcomponentComponent implements OnInit {
  ...
  addPayroll(formtype: any,data: any){
  ...
  private getpaygradefunctional(gstkeyvalue: any) {
    ...
    public displayfnalowance(allow?: any): string | any {
  ...
  public displayfnpayroll(payroll?: any): string | any {
