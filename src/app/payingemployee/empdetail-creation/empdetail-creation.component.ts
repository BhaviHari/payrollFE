...
export class EmpdetailCreationComponent implements OnInit {
  ...
  @ViewChild('autocit') matcityAutocomplete: MatAutocomplete | any;
  @ViewChild('cityInput') cityInput: any;

  @ViewChild('autodis') matdistrictAutocomplete: MatAutocomplete | any;
  @ViewChild('districtInput') districtInput: any;

  @ViewChild('statetype') matstateAutocomplete: MatAutocomplete | any;
  @ViewChild('stateInput') stateInput: any;

  @ViewChild('pintype') matpincodeAutocomplete: MatAutocomplete | any;
  @ViewChild('pinCodeInput') pinCodeInput: any;

  @ViewChild('desg') matdesignationAutocomplete: MatAutocomplete | any;
  @ViewChild('designationInput') designationInput: any;

  @ViewChild('fn') matFHAutocomplete: MatAutocomplete | any;
  @ViewChild('fnInput') fnInput: any;

  @ViewChild('orgtype') matorgAutocomplete: MatAutocomplete | any;
  @ViewChild('orgtypesInput') orgtypesInput: any;


  @ViewChild('rmemp') matAutocomplete: MatAutocomplete | any;
  @ViewChild('rmInput') rmInput: any;

  @ViewChild('empbranch') matAutocompleteempbranch: MatAutocomplete | any;
  @ViewChild('empbranchInput') empbranchInput: any;

  @ViewChild('bs') matAutocompletebs: MatAutocomplete | any;
  @ViewChild('bsInput') bsInput: any;

  @ViewChild('cc') matAutocompletecc: MatAutocomplete | any;
  @ViewChild('ccInput') ccInput: any;

  @ViewChild('candidate') matAutocompletecandidate: MatAutocomplete | any;
  ...
  getcandidateInfoAddressType(type: any){
  ...
  gradeName(){
    let rmkeyvalue: String = "";
      ...
      businessSeg_id=0;
      candidate_Id!: number;
        FocusOut_select_businessSegment(data : any){
          console.log("bs",data);
          this.businessSeg_id = data.id;
        }

        FocusOut_select_Candidate(data : any){
  ...
  private getPinCode(pincodekeyvalue: String) {
  ...
  private getCity(citykeyvalue: String) {
  ...
  private getDistrict(districtkeyvalue: String) {
  ...
  private getState(statekeyvalue: String) {
  ...
  private getOrgType(orgkeyvalue: String) {
  ...
  private getDesignation(desgkeyvalue: String) {
  ...
  private getGrade(rmkeyvalue: String) {
  ...
  private getFunctional(gstkeyvalue: String) {
  ...
  private getEmpBranch(gstkeyvalue: String) {
  ...
  private getBS(rmkeyvalue: String) {
  ...
  private getCC(gstkeyvalue: String) {
 ...
 keyPressNumbersDecimal(event: { which: any; keyCode: any; preventDefault: () => void; }) {
  ...
  public displaydis(autodis?: district): string | any {
  ...
  public displaycit(autocit?: city): string | any {
  ...
  public displayFnpin(pintype?: pincode): string | any {
  ...
  public displayFnstate(statetype?: state): string | any {
  ...
  public displayFnorgtypes(orgtype?: orgtype): string | any {
  ...
  public displayFnDesg(desg?: Designation): string | any {
  ...
  public displayFnGrade(rmemp?: Grade): string | any {
  ...
  public displayFnFunHead(fn?: FunctionHead): string | any {
  ...
  public displayFnEmpbranch(empbranch?: EmployeeBranch): string | any {
  ...
  public displayFnBs(bs?: BusinessSegment): string | any {
  ...
  public displayFnCc(cc?: CostCenter): string | any {
  ...
  public displayFnCan(candidate?: Candidate): string | any {
  ...
  address_copy(){
    ...
    const addressControl = this.empAddForm.get("address") as FormGroup | null;

if (addressControl) {
  const addressArray = addressControl.get('controls') as FormArray | null;

  if (addressArray && addressArray.length > index) {
    const addressAtIndex = addressArray.at(index) as FormGroup;

    addressAtIndex.get("line1")?.setValue(oneline);
    addressAtIndex.get("line2")?.setValue(twoline);
    addressAtIndex.get("line3")?.setValue(threeline);
    addressAtIndex.get("city_id")?.setValue(city);
    addressAtIndex.get("district_id")?.setValue(dis);
    addressAtIndex.get("state_id")?.setValue(state);
    addressAtIndex.get("pincode_id")?.setValue(pin);
  }
}
  ...
  addressvalidation(event: { keyCode: number; preventDefault: () => void; }){
  ...
  getSections(forms: { controls: { employeebankinfo: { controls: any; }; }; }) {
...
private getbank(gstkeyvalue: String) {
...
private getbankbranch(statecodekey: any) {
...
public displayFnbank(banktype?: bank): string | any {
  return banktype ? banktype.name : undefined;
}
// get banktype() {
//   return this.empAddForm.controls.address.get('pin_code');
// }
public displayFnbankbranch(bankbranchtype?: bankbranch): string | any {
