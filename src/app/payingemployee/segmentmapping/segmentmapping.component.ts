...
@ViewChild('pay') matbonusAutocomplete: MatAutocomplete | any;
...
mapSearch(hint: any) {
  ...
  geteditSegments(segment_id  : any) {
...
this.payrollService.getpaycomponenttype(paycomponent_id).subscribe(data => {
  ...
  newSegments()
    ...
    public displaypaycomponent(paycomponent?: any): string | any {
