...
export class AppComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // this.shareService.vendorViewHeaderName.subscribe((result:any) => {
    //   let data: any = result;
    ...
    // this.shareService.branchView.subscribe((res: any) => {
    //   let data: any = res;
  ...
  mobile_popu() {
    ...
    if (sessionData) {
      this.logindata = JSON.parse(sessionData);
    }
    // let logindata = JSON.parse(sessionData);
    this.login_code = this.logindata.code;
...
// 
  ...
  openNav() {
    ...
    if (sidenav && mainContent) {
      ...
      console.error("Sidenav or Main Content element not found!");
    }
  }
  masterData() {
...
@ViewChild('changepassword')changepassword : any;
    change_pwd(){
      ...
      // let logindata = JSON.parse(sessionData);
      if (sessionData) {
        this.logindatas = JSON.parse(sessionData);
      }
